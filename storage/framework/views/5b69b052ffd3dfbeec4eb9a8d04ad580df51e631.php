                    ...
                    <?php if($erro == 0): ?> 
                        <?php $__currentLoopData = $produtos['retorno']['produtos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <?php endif; ?>
                                <?php if(($produto['produto']['estoqueAtual'] - $produto['produto']['estoqueMinimo']) == 0): ?>
                                    <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2 text-warning font-weight-bold"> <?php echo e($produto['produto']['estoqueAtual']); ?> </td>
                                <?php endif; ?>
                                <?php if(($produto['produto']['estoqueAtual'] - $produto['produto']['estoqueMinimo']) < 0): ?>
                                    <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2 text-danger font-weight-bold"> <?php echo e($produto['produto']['estoqueAtual']); ?> </td>
                                <?php endif; ?>
